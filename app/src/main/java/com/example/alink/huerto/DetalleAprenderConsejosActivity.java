 ...
 */
public class DetalleAprenderConsejosActivity extends AppCompatActivity {
    // When requested, this adapter returns a DemoObjectFragment,
    // representing an object in the collection.
    CollectionConsejorAdapter mDemoCollectionPagerAdapter;
    ...
    public void tarea(RequestParams params, final String nombreTabla) {
        ...
        final List<Consejo> items = new ArrayList();
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                if (statusCode == 200) {
                    ...
                    try {
                        ...
                        mDemoCollectionPagerAdapter = new CollectionConsejorAdapter(getSupportFragmentManager(), items);
...
class CollectionConsejorAdapter extends FragmentStatePagerAdapter {
    List<Consejo> items;

    public CollectionConsejorAdapter(FragmentManager fm, List items) {
        super(fm);
        this.items = items;
    }
    ...
    public Fragment getItem(int i) {
        Fragment fragment = new ConsejoFragment(items.get(i));
        Bundle args = new Bundle();
        // Our object is just an integer :-P
        args.putInt(ConsejoFragment.ARG_OBJECT, i + 1);
    ...
    public CharSequence getPageTitle(int position) {
        return items.get(position).getTitulo();
    }
}
...
class ConsejoFragment extends Fragment {
    public static final String ARG_OBJECT = "object";
    public Consejo item;

    public ConsejoFragment(Consejo item) {
        this.item = item;
    }
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View rootView = inflater.inflate(
                R.layout.fragment_collection_object_consejos, container, false);
